...
import { RecordIndexGalleryContainer } from '@/object-record/record-gallery/components/RecordIndexGalleryContainer';
    ...
    <StyledContainer>
      {hasCurrentViewNonReadableFields ? (
        ...
        <>
          ...
          {recordIndexViewType === ViewType.GALLERY && (
            <StyledContainerWithPadding>
              <RecordIndexGalleryContainer
                recordGalleryInstanceId={recordIndexId}
                viewBarInstanceId={recordIndexId}
              />
            </StyledContainerWithPadding>
          )}
